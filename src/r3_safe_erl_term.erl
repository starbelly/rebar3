...
-file("/Users/starbelly/devel/erlang/rebar3/src/r3_safe_erl_term.xrl", 26).
...
-file("/Users/starbelly/devel/erlang/rebar3/src/r3_safe_erl_term.erl", 360).
yystate() -> 13.
...
-file("/Users/starbelly/devel/erlang/rebar3/src/r3_safe_erl_term.xrl", 14).
yyaction_0(TokenChars, TokenLine) ->
     tokenize_atom (TokenChars, TokenLine) .

-compile({inline,yyaction_1/3}).
-file("/Users/starbelly/devel/erlang/rebar3/src/r3_safe_erl_term.xrl", 15).
yyaction_1(TokenChars, TokenLen, TokenLine) ->
     tokenize_atom (escape (unquote (TokenChars, TokenLen)), TokenLine) .

-compile({inline,yyaction_2/3}).
-file("/Users/starbelly/devel/erlang/rebar3/src/r3_safe_erl_term.xrl", 16).
yyaction_2(TokenChars, TokenLen, TokenLine) ->
     { token, { string, TokenLine, escape (unquote (TokenChars, TokenLen)) } } .

-compile({inline,yyaction_3/2}).
-file("/Users/starbelly/devel/erlang/rebar3/src/r3_safe_erl_term.xrl", 17).
yyaction_3(TokenChars, TokenLine) ->
     { token, { integer, TokenLine, list_to_integer (TokenChars) } } .

-compile({inline,yyaction_4/2}).
-file("/Users/starbelly/devel/erlang/rebar3/src/r3_safe_erl_term.xrl", 18).
yyaction_4(TokenChars, TokenLine) ->
     { token, { list_to_atom (TokenChars), TokenLine } } .

-compile({inline,yyaction_5/2}).
-file("/Users/starbelly/devel/erlang/rebar3/src/r3_safe_erl_term.xrl", 19).
yyaction_5(TokenChars, TokenLine) ->
     { token, { list_to_atom (TokenChars), TokenLine } } .

-compile({inline,yyaction_6/1}).
-file("/Users/starbelly/devel/erlang/rebar3/src/r3_safe_erl_term.xrl", 20).
yyaction_6(TokenLine) ->
     { token, { dot, TokenLine } } .

-compile({inline,yyaction_7/1}).
-file("/Users/starbelly/devel/erlang/rebar3/src/r3_safe_erl_term.xrl", 21).
yyaction_7(TokenLine) ->
     { token, { '/', TokenLine } } .

-compile({inline,yyaction_8/0}).
-file("/Users/starbelly/devel/erlang/rebar3/src/r3_safe_erl_term.xrl", 22).
yyaction_8() ->
     skip_token .
